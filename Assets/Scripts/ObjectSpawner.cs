...
public class ObjectSpawner : MonoBehaviour
{
    ...
    public GameObject childMale;
    public GameObject childFemale;
    ...
    void Start()
    {
        ...
        {
            targetArray[i] = randPerson.Next(Min, Max);
        }
    ...
    private void Update(){
        if(spwnd == true){
            ...
            distanceText.text = "Distance: " + distanceF.ToString("F1") + "feet";
        }
